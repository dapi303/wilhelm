...
TEST(parseSingleTriangleFace, BasicAssertions) {
  ModelData model;
  model.vertex.push_back(std::make_shared<Vertex>(Vertex(1, 2, 3)));
  model.vertex.push_back(std::make_shared<Vertex>(Vertex(10, 20, 30)));
  model.vertex.push_back(std::make_shared<Vertex>(Vertex(100, 200, 300)));
...
TEST(faceUsesProperVertexTexture, BasicAssertions) {
  ...
  model.vertex.push_back(std::make_shared<Vertex>(10, 20, 30));
